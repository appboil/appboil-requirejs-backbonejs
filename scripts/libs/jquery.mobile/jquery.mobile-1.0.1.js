...
( function ($, undefined) {
    ...
    function reFocus(page) {
        ...
        if (pageTitle.length) {
            // HACK: the line below was commented by Piotr to fix flicker problem of jqm running on iPad/PhoneGap
            // Github issue: https://github.com/jquery/jquery-mobile/issues/2856
//			pageTitle.focus();
        }
        else {
            page.focus();
    ...
    $.widget("mobile.selectmenu", $.mobile.widget, {
        ...
        setButtonText:function () {
            ...
            this.button.find(".ui-btn-text").text(function () {
                ...
                return selected.length ? selected.map(
                    function () {
                        return $(this).text();
